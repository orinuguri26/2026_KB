# Vue + Pinia 장바구니 예제 프로젝트

이 프로젝트는 **Vue 3 + Pinia + Vue Router**를 이용해 만든 아주 기본적인 장바구니 예제입니다.
...
즉, **여러 화면이 함께 사용하는 공용 데이터 센터**입니다.
...
이 프로젝트는 학습용 예제라 단순하지만,
실무형으로 발전시키려면 아래 기능을 추가할 수 있습니다.
